...
public class IPInputControllerTest extends ApplicationTest {
    ...
    public void setUp() {
        ...
        ipInputController.setIPtxt(ipTextField);
        ipInputController.setAwaitingLoginText(awaitingLoginText);
        ipInputController.setBtnSend(sendButton);
        ipInputController.setBtnExit(exitButton);
    }
...
//        Subscriber mockSubscriber = new Subscriber(1, 100, "John Doe", "123456789", "johndoe@gmail.com");
//        Platform.runLater(() -> {
//            assertDoesNotThrow(() -> ipInputController.loadSubscriber(mockSubscriber));
//            System.out.println("loadSubscriber executed successfully.");
//        });
...
//    }
    ...
    public void testGetIP() {
        ...
        assertEquals("127.0.0.1", ipInputController.getIPtxt().getText());
    }
